...
export default async function DynamicArticlePage({
  ...
  // (No table of contents: the "On this page" sidebar was decommissioned —
  // headings alone are the navigation contract, matching the article lint's
  // no-manual-toc rule on the authoring side.)
  const article = {
    slug: metadata.slug,
