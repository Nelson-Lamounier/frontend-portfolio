 ...
 * Since this is the dedicated admin application, ALL routes are protected by default,
 * except the login page and NextAuth API endpoints.
 *
...
function isProtectedAdminRoute(pathname: string): boolean {
  return !pathname.startsWith(ADMIN_LOGIN_PATH) && !pathname.startsWith('/api/auth')
}
