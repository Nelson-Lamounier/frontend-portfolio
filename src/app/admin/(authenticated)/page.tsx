 ...
 *
 * Dedicated landing page for the admin portal with summary statistics
 * and quick-action cards. Uses TanStack Query hooks for data fetching
...
import { useAdminResumes } from '@/lib/hooks/use-admin-resumes'
