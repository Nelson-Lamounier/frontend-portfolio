...
<Callout variant="info" title="Progressive Security Severity">
  ...
  CRITICAL. Production blocks on **everything**, including LOW severity. This
  mirrors real-world risk tolerance: experimentation in dev, caution in staging,
