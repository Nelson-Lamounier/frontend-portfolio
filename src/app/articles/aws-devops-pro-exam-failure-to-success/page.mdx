...
import { ScenarioKeywords } from '@/components/articles'
import { EliminationList } from '@/components/articles'
...
import ecsBlueGreenDesign from './ecs_blue_green_deployment.png'
import multiRegionDRArchitectureDesign from './multi_region_dr_architecture.png'
import autoScalingArchitectureDesign from './auto_scaling_architecture.png'
...
<ScenarioKeywords
  keywords={[
    ...
    {
      keyword: 'gradual traffic shift',
      solution: 'CodeDeploy with canary/linear configs',
    },
    {
      keyword: 'automated rollback',
      solution: 'CloudWatch alarms + deployment triggers',
    },
    { keyword: 'audit compliance', solution: 'CloudTrail integration' },
  ]}
/>
...
<div className="my-8 flex justify-center">
  <div className="w-full max-w-xs sm:max-w-sm md:max-w-md">
    <Image
      src={autoScalingArchitectureDesign}
      alt="Auto Scaling architecture diagram showing lifecycle hooks, warm pools, and application load balancer integration"
      className="h-auto w-full"
    />
  </div>
</div>
